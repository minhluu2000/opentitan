...
#(
  ...
  if (SecStartTriggerDelay > 0) begin : gen_start_delay
    ...
    assign count_d       = !start_i ? '0 : start_trigger ? count_q : count_q + 1'b1;
...
`else
  ...
  assign cipher_prng_reseed_o = |mr_cipher_prng_reseed;
`endif
`ifdef BUGNUMAESCON6T
  assign cipher_key_clear_o      = &mr_cipher_data_out_clear;
  assign cipher_data_out_clear_o = ^mr_cipher_key_clear;
`else
  assign cipher_key_clear_o      = |mr_cipher_key_clear;
  assign cipher_data_out_clear_o = |mr_cipher_data_out_clear;
`endif
`ifdef BUGNUMAESCON12
  assign prng_data_req_o   = &mr_prng_reseed_req;
  assign prng_reseed_req_o = &mr_prng_data_req;
`elsif BUGNUMAESCON13
  assign prng_data_req_o   = ^mr_prng_reseed_req;
  assign prng_reseed_req_o = ^mr_prng_data_req;
`else
...
`endif
`ifdef BUGNUMAESCON7T
  assign start_we_o       = &mr_start_we;
  assign prng_reseed_o    = mr_prng_reseed_we;
  assign prng_reseed_we_o = &mr_prng_reseed;
`else
  assign start_we_o       = |mr_start_we;
...
`ifdef BUGNUMAESCON14
  assign ctrl_we_o    = &mr_data_in_we;
  assign data_in_we_o = &mr_ctrl_we;
`elsif BUGNUMAESCON15
...
`ifdef BUGNUMAESCON17
  assign output_lost_we_o = &mr_output_valid;
  assign output_valid_o   = &mr_output_lost_we;
`elsif BUGNUMAESCON18
...
`ifdef BUGNUMAESCON4
  assign sp2v_sig[0] = cipher_out_valid_i;
  assign sp2v_sig[1] = cipher_out_valid_i;
  assign sp2v_sig[2] = cipher_out_valid_i;
  assign sp2v_sig[3] = cipher_out_valid_i;
  assign sp2v_sig[4] = cipher_out_valid_i;
`elsif BUGNUMAESCON5
  assign sp2v_sig[0] = cipher_in_ready_i;
  // missing sp2v_sig[1] and sp2v_sig[2]
  assign sp2v_sig[3] = cipher_dec_key_gen_i;
  assign sp2v_sig[4] = ctr_ready_i;
`elsif BUGNUMAESCON2T
  assign sp2v_sig[0] = cipher_in_ready_i;
  assign sp2v_sig[1] = cipher_out_valid_i;
  assign sp2v_sig[2] = cipher_crypt_i;
  // missing sp2v_sig[3] and sp2v_sig[4]
`else
  assign sp2v_sig[0] = cipher_in_ready_i;
  assign sp2v_sig[1] = cipher_out_valid_i;
  assign sp2v_sig[2] = cipher_crypt_i;
...
`ifdef BUGNUMAESCON1
  assign cipher_in_ready = sp2v_sig_chk[1];
`else
  assign cipher_in_ready = sp2v_sig_chk[0];
`endif
`ifdef BUGNUMAESCON2
  assign cipher_out_valid = sp2v_sig_chk[0];
`else
  assign cipher_out_valid = sp2v_sig_chk[1];
`endif
`ifdef BUGNUMAESCON3
  assign cipher_crypt = sp2v_sig_chk[3];
`elsif BUGNUMAESCON1T
  assign cipher_crypt = sp2v_sig_chk[0];
`else
